    ...
    <section className="pricing-section" id="pricing">
      ...
      <div className="pricing-grid-3col">
        ...
        <div className="pricing-card-box featured-pro-card">
          ...
          <ul className="pricing-checklist">
            <li>
              <span className="check-cyan">✓</span> 50,000 API requests per month
            </li>
            <li>
            ...
            <li>
              <span className="check-cyan">✓</span> Higher rate limits (&le; 200ms response time)
            </li>
            <li>
        ...
        <div className="pricing-card-box">
          ...
          <ul className="pricing-checklist">
            <li>
              <span className="check-cyan">✓</span> 500,000+ API requests per month
            </li>
            <li>
